...
{
    public class ApplyMaintainListResultModel : IPaginationModel
    {
        List<ApplyMaintainListDataModel> m_data = new List<ApplyMaintainListDataModel>();
        public List<ApplyMaintainListDataModel> Data { get { return m_data; } set { m_data = value; } }
        /// <summary>
        /// 分頁模型
        /// </summary>
